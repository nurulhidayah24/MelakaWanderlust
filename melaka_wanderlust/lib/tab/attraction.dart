...
class AttractionTab extends StatelessWidget {
  ...
  void addAttractionToWishlist(
      BuildContext context, Attraction attraction) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String? username = prefs.getString('username');
    Provider.of<Wishlist>(context, listen: false)
        .addPlaceToUserWishlist(username!,attraction);
                      ...
                      return GoogleMap(
                        ...
                        markers: Set<Marker>.of(
                          beachList.map((placeInfo) {
                            return Marker(
                              markerId: MarkerId(
                                  '${placeInfo.type}_${placeInfo.name}'),
                          ...
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                bool isFavorite =
                                value.isPlaceInWishlist(attraction);
                                return PlaceTile(
                                    place: attraction,
